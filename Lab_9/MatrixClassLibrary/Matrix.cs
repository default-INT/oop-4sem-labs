    ...
    public class Matrix
    {
        ...
        public static int[,] sumMatrix(int[,] matrix1, int[,] matrix2)
        {
            ...
            if (matrix1.GetUpperBound(0) != matrix2.GetUpperBound(0)
                || matrix1.GetUpperBound(1) != matrix2.GetUpperBound(1)) throw new DimensionMismatchException();
        ...
        public static int[,] prodMatrix(int[,] matrix1, int[,] matrix2)
        {
            ...
            if (matrix1.GetUpperBound(1) != matrix2.GetUpperBound(0)) throw new WrongMultiplicationException();
